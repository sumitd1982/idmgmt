...
echo -e "${CYAN}╠══════════════════════════════════════════════════════╣${NC}"
echo -e "${CYAN}║  Web App:    https://80.225.246.32/idmgmt            ║${NC}"
echo -e "${CYAN}║  API:        https://80.225.246.32/idmgmt/api        ║${NC}"
echo -e "${CYAN}║  API Health: https://80.225.246.32/idmgmt/api/health ║${NC}"
echo -e "${CYAN}║  DB Admin:   localhost:3307 (MySQL)                  ║${NC}"
echo -e "${CYAN}╠══════════════════════════════════════════════════════╣${NC}"
echo -e "${CYAN}║  Existing app still runs at: https://80.225.246.32  ║${NC}"
echo -e "${CYAN}╚══════════════════════════════════════════════════════╝${NC}"
echo ""
