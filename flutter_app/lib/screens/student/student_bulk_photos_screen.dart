// ============================================================
// Student Bulk Photo Upload Screen
// ============================================================
...
class StudentBulkPhotosScreen extends ConsumerWidget {
  const StudentBulkPhotosScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: BulkPhotoUploadWidget(
          config: BulkPhotoUploadConfigs.student(schoolId: schoolId),
          onDone: () => context.go('/students'),
        ),
      ),
    );
  }
