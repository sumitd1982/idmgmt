  ...
  static BulkUploadConfig student({String? schoolId, String? branchId}) =>
      BulkUploadConfig(
        ...
        templateColumns: const [
          ...
          // ── Identity (optional)
          _ColumnInfo('middle_name',   false, 'Middle name'),
          _ColumnInfo('admission_no',  false, 'Admission number'),
          _ColumnInfo('roll_number',   false, 'Class roll number'),
          _ColumnInfo('blood_group',   false, 'A+ / A- / B+ / B- / O+ / O- / AB+ / AB-'),
          _ColumnInfo('category',      false, 'General / OBC / SC / ST / EWS'),
          _ColumnInfo('nationality',   false, 'e.g. Indian'),
          _ColumnInfo('religion',      false, 'e.g. Hindu'),
          _ColumnInfo('aadhaar_no',    false, '12-digit Aadhaar number'),
          _ColumnInfo('school_house_name', false, 'e.g. Red House'),
          // ── Address
          _ColumnInfo('address_line1', false, 'Street address'),
          _ColumnInfo('address_line2', false, 'Address line 2'),
          _ColumnInfo('city',          false, 'City'),
          _ColumnInfo('state',         false, 'State / UT'),
          _ColumnInfo('country',       false, 'Country (default: India)'),
          _ColumnInfo('zip_code',      false, '6-digit PIN code'),
          // ── Transport — bus
          _ColumnInfo('bus_route',     false, 'Bus route number'),
          _ColumnInfo('bus_stop',      false, 'Bus stop name'),
          _ColumnInfo('bus_number',    false, 'Bus vehicle number'),
          // ── Transport — private cab
          _ColumnInfo('private_cab_flag',           false, 'TRUE / FALSE'),
          _ColumnInfo('parents_personally_pick',    false, 'TRUE / FALSE'),
          _ColumnInfo('private_cab_regn_no',        false, 'Cab registration number'),
          _ColumnInfo('private_cab_model',          false, 'e.g. Toyota Innova'),
          _ColumnInfo('private_cab_driver_name',    false, 'Driver full name'),
          _ColumnInfo('private_cab_driver_license_no', false, 'Driver licence number'),
          _ColumnInfo('private_cab_license_expiry_dt', false, 'YYYY-MM-DD'),
          // ── Guardian 1
          _ColumnInfo('guardian_type',        true,  'father / mother / guardian_1 / guardian_2'),
          _ColumnInfo('guardian_first_name',  true,  'Guardian first name'),
          _ColumnInfo('guardian_last_name',   false, 'Guardian last name'),
          _ColumnInfo('guardian_relation',    false, 'e.g. Father, Uncle'),
          _ColumnInfo('guardian_phone',       true,  '10-digit mobile number'),
          _ColumnInfo('guardian_whatsapp',    false, 'WhatsApp number'),
          _ColumnInfo('guardian_email',       false, 'Guardian email'),
          _ColumnInfo('guardian_occupation',  false, 'Occupation'),
          // ── Guardian 2 (optional second guardian)
          _ColumnInfo('guardian2_type',       false, 'father / mother / guardian_1 / guardian_2'),
          _ColumnInfo('guardian2_first_name', false, 'Second guardian first name'),
          _ColumnInfo('guardian2_last_name',  false, 'Second guardian last name'),
          _ColumnInfo('guardian2_phone',      false, '10-digit mobile number'),
          _ColumnInfo('guardian2_email',      false, 'Second guardian email'),
          // ── SCD / audit
